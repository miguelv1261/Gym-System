  ...
  <ul>
    <li class="<?php if ($page == 'dashboard') {
      echo 'active';
          ...
          class="fas fa-tachometer-alt"></i> <span>Escritorio</span></a> </li>
    <li class="submenu"> <a href="#"><i class="fas fa-users"></i> <span>Usuarios</span> <span
          class="label label-important"><?php include 'dashboard-usercount.php'; ?> </span></a>
      <ul>
        <li class="<?php if ($page == 'members') {
          echo 'active';
        } ?>"><a href="members.php"><i
              class="fas fa-arrow-right"></i> Ver Usuarios</a></li>
        <!--
    ...
    <li class="submenu"> <a href="#"><i class="fas fa-list"></i> <span>Planes</span> <span
          class="label label-important"><?php include 'dashboard-usercount.php'; ?> </span></a>
      <ul>
        <li class="<?php if ($page == 'members') {
          echo 'active';
        } ?>"><a href="plan.php"><i class="fas fa-arrow-right"></i>
            Ver Planes</a></li>
        <!--
        <li class="<?php if ($page == 'members-entry') {
          echo 'active';
        } ?>"><a href="plan-entry.php"><i class="fas fa-arrow-right"></i> Registrar Plan</a></li>
        <li class="<?php if ($page == 'members-remove') {
          echo 'active';
        } ?>"><a href="remove-member.php"><i class="fas fa-arrow-right"></i> Eliminar Plan</a></li>
        <li class="<?php if ($page == 'members-update') {
          echo 'active';
        } ?>"><a href="edit-member.php"><i class="fas fa-arrow-right"></i> Editar Plan</a></li>
        -->
      </ul>
    </li>
    <li class="submenu"> <a href="#"><i class="fas fa-dumbbell"></i> <span>Equipo</span> <span
          class="label label-important"><?php include 'dashboard-equipcount.php'; ?> </span></a>
      <ul>
        <li class="<?php if ($page == 'list-equip') {
          echo 'active';
        } ?>"><a href="equipment.php"><i
              class="fas fa-arrow-right"></i> Ver Equipo </a></li>
        <!-- 
    ...
    <li class="<?php if ($page == 'manage-customer-progress') {
      echo 'active';
    } ?>"><a href="customer-progress.php"><i
          class="fas fa-tasks"></i> <span>Progreso de Usuarios</span></a></li>
    <!-- 
    ...
    <li class="<?php if ($page == 'staff-management') {
      echo 'active';
          ...
          class="fas fa-briefcase"></i> <span>Staff</span></a></li>
    <li class="submenu"> <a href="#"><i class="fas fa-file"></i> <span>Reportes</span></a>
      <ul>
        ...
        <li class="<?php if ($page == 'c-p-r') {
          echo 'active';
        } ?>"><a href="progress-report.php"><i
              class="fas fa-arrow-right"></i> Reporte de Progreso</a></li>
      </ul>
    </li>
